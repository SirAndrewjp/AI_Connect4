...
public class Connect4Board {
  ...
  public Connect4Board(int width, int height, boolean player) {
    this.width = width;
    this.height = height;
    ...
    else nextTurn = PLAYER_2_TURN;
  }

  public Connect4Board(boolean player) {
    this(7, 6, player);
  }

  public Connect4Board(int[][] contents, boolean nextTurn) {
    this(contents[0].length, contents.length, nextTurn);
